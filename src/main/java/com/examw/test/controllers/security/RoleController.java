...
public class RoleController {
	...
	public String edit(Model model){
		...
		model.addAttribute("STATUS_ENABLED_VALUE", Role.STATUS_ENABLED);
		model.addAttribute("STATUS_ENABLED_NAME", this.roleService.loadStatusName(Role.STATUS_ENABLED));
		model.addAttribute("STATUS_DISABLE_VALUE", Role.STATUS_DISABLE);
		model.addAttribute("STATUS_DISABLE_NAME", this.roleService.loadStatusName(Role.STATUS_DISABLE));
